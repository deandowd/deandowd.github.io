...
(function($) {
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			global:		{ range: '*', href: '/assets/style.css', containers: 1400, grid: { gutters: 50 } },
			wide:		{ range: '-1680', href: '/assets/style-wide.css', containers: 1200, grid: { gutters: 40 } },
			normal:		{ range: '-1280', href: '/assets/style-normal.css', containers: 960, viewport: { scalable: false } },
			narrow:		{ range: '-980', href: '/assets/style-narrow.css', containers: '95%', grid: { gutters: 30 } },
			narrower:	{ range: '-840', href: '/assets/style-narrower.css', grid: { collapse: 1 } },
			mobile:		{ range: '-736', href: '/assets/style-mobile.css', containers: '100%', grid: { gutters: 15, collapse: 2 } }
		},
		plugins: {
			layers: {
				config: {
